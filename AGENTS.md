...
- Phase 4 / GOAL-005 is **done under the evidence contract**: required-ci green on tip `2d97005` (CI run 31295151575); UI/backend/test pack in `docs/validation/phase-4-evidence-pack.md` + `assets/phase-4/`; checklist residuals dated for TASK-035. Merge to `main` still required before calling the merge commit done.
