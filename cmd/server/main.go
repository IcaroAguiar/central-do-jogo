...
import (
	...
	"github.com/IcaroAguiar/central-do-jogo/internal/app"
...
func run() error {
	...
	router, err := app.NewHTTPHandler(cfg, pool)
	if err != nil {
	...
	go func() {
		logger.Info("listening", "addr", cfg.HTTPAddr, "auth_enabled", cfg.Auth.Enabled)
