...
- `adr/`: decisões arquiteturais e seus trade-offs (toolchain em `0000`, allowlist em `0001`, layout de pacotes em `0002`).
- `validation/`: contrato de evidência de QA por fase, checklists e recibos de smoke (contributor-facing, English).
